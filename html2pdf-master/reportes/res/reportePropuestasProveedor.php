...
<page backtop="50mm" backbottom="15mm" backleft="6mm" backright="6mm">
    <page_header>
        <h4 style="width: 100%; text-align: center">
            Reporte de propuestas pago por proveedor
        </h4>
        <?php 
...
<!--                <th style="width: 17%; text-align: center; border: solid 1px black; background: rgb(200,200,200)">
                    Total autorizado
                </th>-->
            </tr>
        </thead>
        <tbody style="width: 100%; border: solid 1px black;">
            <?php
               $conexion = new Conexion();
               $conexion->abrirBD();
               $qr = "SELECT * FROM VistaCuentasPorPagarProveedor";
            ...
            <tr>
                ...
                <td style="border: solid 1px black; text-align: right; width: 20%;">
                    <?php echo number_format($row['LimiteCredito'], 2, '.', ',');  ?>
                </td>
                <td style="border: solid 1px black; text-align: right; width: 20%;">
                    <?php echo number_format($row['Deuda'], 2, '.', ','); ?>
                </td>
                <td style="border: solid 1px black; text-align: right; width: 20%;">
                    <?php echo number_format($row['TotalPropuesto'], 2, '.', ','); ?>
                </td>
<!--                <td style="border: solid 1px black; text-align: right; width: 17%;">
                    <?php echo number_format($row['TotalAutorizado'], 2, '.', ','); ?>
                </td>-->
            </tr>
            <?php
                }
