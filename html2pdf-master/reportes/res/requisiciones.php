...
<page backtop="55mm" backbottom="15mm" backleft="6mm" backright="6mm">
    <page_header>
        <?php
            ...
            $query = "SELECT Nombre FROM Obra WHERE IdObra = ". $idProyecto;
            $result = mysqli_query($conexion->mysqli, $query);
            $result = mysqli_fetch_assoc($result);
            $NombreProyecto = utf8_encode($result["Nombre"]);
            ...
            <tr style="width: 100%;">
                <td style="width: 35%">
                     <h4 style="width: 20%; text-align: center">
                        Requisiciones. Proyecto: <?php echo $NombreProyecto ?>
                    </h4>
                </td>
                <td style="width: 25%">
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <thead style="width: 100%; font-size: 11px;">
            <tr>
                <th style="width: 8%; text-align: center; border: solid 1px black; background: rgb(200, 200, 200)">
                    Folio
                </th>
                ...
                <th style="width: 20%; text-align: left; border: solid 1px black; background: rgb(200, 200, 200)">
                    Material
                </th>
                <th style="width: 9%; text-align: left; border: solid 1px black; background: rgb(200, 200, 200)">
                    Unidad
                </th>
        ...
        <tbody style="width: 100%; border: solid 1px black;">
            ...
            $qr = "SELECT * FROM VistaRequisicionesConsulta WHERE IdObra = ". $idProyecto ." AND ". $wheres;
