<script src="pages/compras/requisesp/NuevoMaterial/materialScript.js" type="text/javascript"></script>
                        ...
                        <fieldset class="scheduler-border" style="margin-bottom: 0px !important;">
                            ...
                            <div class="form-group">
                                <div class="col-md-6" style="padding-bottom: 10px !important">
                                    ...
                                    <select name="tipoMedida" id="tipoMedida" class="form-control" required=""></select>
                                </div>
