...
<script src="pages/compras/requisicionesEspeciales/NuevoProveedor/listadoProveedoresScript.js" type="text/javascript"></script>
    ...
    $( document ).ready(function() {
        ...
        $("#dolaresMat").keyup( function() {
            if ($(this).val() != "" && $(this).val() != "undefined" && $(".dolarActual").val() != "" && $(".dolarActual").val() != "undefined") {
                ...
                if ($.isNumeric(p))
                    $("#nprecioMat").val((parseFloat(p) * parseFloat($(".dolarActual").val().replace(/\,/g, ''))).toFixed(2));
                else
                    $("#nprecioMat").val("");
            }
        });
        ...
        $("#nprecioMat").keyup( function() {
            if ($(this).val() != "" && $(this).val() != "undefined" && $(".dolarActual").val() != "" && $(".dolarActual").val() != "undefined") {
                ...
                if ($.isNumeric(p))
                    $("#dolaresMat").val((parseFloat(p) / parseFloat($(".dolarActual").val())).toFixed(2));
                else
                    $("#dolaresMat").val("");
            }
        });
