<script src="pages/compras/requisicionesEspeciales/NuevoProveedor/proveedoresScript.js" type="text/javascript"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formProv" role="form">
                    ...
                    <div>
                        ...
                        <div class="form-group col-md-1" style="margin: 0px"></div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="validarFormularioNP($('#accion').val(),$('#idRegistro').val())">Aceptar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script type="text/javascript">
    ...
    function validarFormularioNP(accion, idRegistro) {
        if ($("#formProv").valid()) {
            guardarProveedor(accion, idRegistro);
