...
if (!empty($_POST)) {
    ...
    $dataTable->construyeConsulta(sprintf("SELECT * FROM %s WHERE IdCajaChica = %d AND FolioFactura IS NOT NULL AND FechaRegistroCorte = '%s' AND Eliminado IS NULL", $dataTable->nombreTabla, $idCajaChica, $fecha));
