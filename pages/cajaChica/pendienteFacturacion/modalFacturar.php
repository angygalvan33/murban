            ...
            <div class="modal-body">
                ...
                <form id="formFact" role="form">
                    ...
                    <div style="margin-top: 10px">
                        ...
                        <input required="" type="text" id="fecha_factura" value="<?php echo date("Y-m-d"); ?>">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" onclick="validarFormularioFact($('#idRegistroEsperaFacturacion').val(), $('#factura').val(), $('#fecha_factura').val())">Facturar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script type="text/javascript">
    ...
    function validarFormularioFact(idRegistroEsperaFacturacion, numFact, fecha) {
        if ($("#formFact").valid()) {
            facturarCompra(idRegistroEsperaFacturacion, numFact, fecha);
