...
$documento
    ...
    ->setTitle('Detalle de Cobros');
 
$nombreDelDocumento = "DetalledeCobros.xlsx";
...
if($fechaIni != -1)
	$hoja->setCellValueByColumnAndRow(2, 5, urldecode('Fecha Inicio:').': ' .  $fechaIni . ' Fecha Fin: ' . $fechaFin);
...
$datos = $reporte->getDetalledeCobros($fechaIni, $fechaFin);

      
$hoja->setCellValueByColumnAndRow(1, 7, "PROYECTO");
$hoja->setCellValueByColumnAndRow(2, 7, "CLIENTE");
$hoja->setCellValueByColumnAndRow(3, 7, "FOLIO FACTURA");
$hoja->setCellValueByColumnAndRow(4, 7, "MONTO");
$hoja->setCellValueByColumnAndRow(5, 7, "TIPO COBRO");
$hoja->setCellValueByColumnAndRow(6, 7, "FECHA COBRO");
...
for($i=0; $i<$longitud; $i++)
{
    ...
    $hoja->setCellValueByColumnAndRow(3, $i+8, $datos[$i]["Folio"]);
    $hoja->setCellValueByColumnAndRow(4, $i+8, $datos[$i]["Monto"]);
    $hoja->setCellValueByColumnAndRow(5, $i+8, $datos[$i]["TipoDC"]);
	$hoja->setCellValueByColumnAndRow(6, $i+8, $datos[$i]["FechaCobro"]);	
